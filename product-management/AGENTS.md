...
## Purpose
The value workspace — what value the Jegzmenswear platform delivers, to whom, proven how, and the status of each value outcome. Value is tracked independently from how engineering delivers it; the delivery plan lives in `delivery-management/` and serves this workspace, not the reverse.
